package com.disciplinasclient.disciplinasclient.controller;


import com.disciplinasclient.disciplinasclient.models.DisciplinaDTO;
...
public class DisciplinaController {
    ...
    public DisciplinaDTO getDisciplina() throws Exception {
        ...
        return DisciplinaDTO.builder()
                .nome("Arquitetura de software - microsserviços")
                .cargaHoraria(30)
                .dataInicio(new Date())
